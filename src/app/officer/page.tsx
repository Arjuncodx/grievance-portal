...
export default async function OfficerPlaceholderPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-canvas">
      <Header userName={session.email} homeHref="/officer" />
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 py-16 text-center sm:px-6">
        <div className="card flex w-full flex-col items-center py-12">
          ...
          <h1 className="text-xl font-bold text-ink">Department Officer Dashboard</h1>
          <p className="mt-2 max-w-md text-sm leading-relaxed text-ink-muted">
            This dashboard is coming soon. Complaints routed to your department will appear here
            for review, approval and status updates.
          </p>
